...
fn main() {
    ...
    dioxus_desktop::launch_cfg(RoutePage, config);
}
...
#[component]
fn RoutePreview(cx: Scope) -> Element {
    cx.render( rsx!(
        div { class: "route-preview",
            div { class: "route-name-and-star-container",
                div { class: "route-name-container", h3 { class: "route-name", "Name" } }
...
fn RoutePage(cx: Scope) -> Element{
    cx.render( rsx!(
        ...
        div { class: "left-right-container", Profile { logged: false, size: 3.0 } }
